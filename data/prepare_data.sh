...
cp /content/drive/MyDrive/python/CrowdHuman_train01.zip CrowdHuman_train01.zip
cp /content/drive/MyDrive/python/CrowdHuman_train02.zip CrowdHuman_train02.zip
cp /content/drive/MyDrive/python/CrowdHuman_train03.zip CrowdHuman_train03.zip
cp /content/drive/MyDrive/python/CrowdHuman_val.zip CrowdHuman_val.zip

cp /content/drive/MyDrive/python/annotation_train.odgt annotation_train.odgt
cp /content/drive/MyDrive/python/annotation_val.odgt annotation_val.odgt
